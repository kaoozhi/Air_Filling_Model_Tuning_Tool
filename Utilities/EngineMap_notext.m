...
% Pman_vect = linspace(12,max(Pman),64);
Pman_vect = linspace(12,312,64);
% err = -(Masp-Masp_est)./Masp;
...
% [a,b] = ndgrid(m,n);
err_q = griddata(Ne,Pman,err,Ne_q,Pman_q,'natural');
...
surfc(Ne_q,Pman_q,err_q,'FaceColor','interp')
xlim([600, max(Ne)+500])
